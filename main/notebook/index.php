...
if (isset($_GET['action']) && $_GET['action'] == 'exportnote' && is_numeric($_GET['notebook_id'])) {
	$notebook_id = $_GET['notebook_id'];
	$course_id = api_get_course_int_id();
	$t_notebook = Database :: get_course_table(TABLE_NOTEBOOK);
			
	$sql = "SELECT title, description FROM $t_notebook WHERE notebook_id=".$notebook_id." AND c_id=".$course_id;
	...
	NotebookManager::export_notes_to_pdf($desc, $title);
}
