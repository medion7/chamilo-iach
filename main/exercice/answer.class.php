...
/**
	 ...
	 * @param	integer	Answer position
	 */
	function updateAnswers($answer,$comment, $correct, $weighting,$position,$destination) { // edited Lia
	...
	function save() {
		...
		for ($i=1;$i <= $this->new_nbrAnswers; $i++) {
            ...
            if (!(isset($this->position[$i]))) {
                ...
                $this->updateAnswers($answer, $comment, $correct, $weighting, $position, $destination); // Edited Lia
            }
        }
		if ($flag == 1) {
