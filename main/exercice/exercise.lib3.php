...
function get_count_exam_results($exercise_id = null) {
    ...
    if ($is_allowedToEdit || $is_tutor) {
        ...
        $sql="SELECT DISTINCT te.exe_id
                ...
                WHERE te.status != 'incomplete' AND te.status != 'partial' AND te.exe_cours_id='" . api_get_course_id() . "'  $user_id_and  $session_id_and AND ce.active <>-1 AND orig_lp_id = 0 AND orig_lp_item_id = 0 $exercise_where ";
