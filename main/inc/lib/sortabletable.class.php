...
class SortableTable extends HTML_Table {
	 ...
	 */
	public function __construct($table_name = 'table', $get_total_number_function = null, $get_data_function = null, $default_column = 1, $default_items_per_page = 70, $default_order_direction = 'ASC') {
