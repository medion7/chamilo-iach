...
$server->wsdl->addComplexType(
    ...
    array(
        ...
        'city_state' => array('name' => 'city_state', 'type' => 'xsd:string'),
        'country' => array('name' => 'country', 'type' => 'xsd:string'),
        'graduate' => array('name' => 'graduate', 'type' => 'xsd:string'),
        'other_titles' => array('name' => 'other_titles', 'type' => 'xsd:string'),
        'hearabout' => array('name' => 'hearabout', 'type' => 'xsd:string'),
        'expiration_date' => array('name' => 'expiration_date', 'type' => 'xsd:string'),
        'original_user_id_name' => array('name' => 'original_user_id_name', 'type' => 'xsd:string'),
        'original_user_id_value' => array('name' => 'original_user_id_value', 'type' => 'xsd:string'),
        'extra' => array('name' => 'extra', 'type' => 'tns:extrasList'),
...
function WSCreateUser($params) {
    ...
    $other_titles = $params['other_titles'];
    ...
    if ($result) {
        ...
        // Save the external system's id into user_field_value table.
        $res = UserManager::update_extra_field_value($return, $original_user_id_name, $original_user_id_value);
		$res = UserManager::update_extra_field_value($return, 'salutation', $salutation);
		$res = UserManager::update_extra_field_value($return, 'address', $address);
        $res = UserManager::update_extra_field_value($return, 'postcode', $postcode);
        $res = UserManager::update_extra_field_value($return, 'city_state', $city_state);
        $res = UserManager::update_extra_field_value($return, 'country', $country);
        $res = UserManager::update_extra_field_value($return, 'graduate', $graduate);
        $res = UserManager::update_extra_field_value($return, 'other_titles', $other_titles);
        $res = UserManager::update_extra_field_value($return, 'hearabout', $hearabout);
...
$server->register('WSListSessions',           // method name
    //array('date_start' => 'xsd:string', 'date_end' => 'xsd:string', 'secret_key' => 'xsd:string'), // input parameters
