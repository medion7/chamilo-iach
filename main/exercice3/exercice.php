...
$https = $_SERVER["HTTPS"];
if($course=='999' and ($https!='on' or $url!='exams.vithoulkas.edu.gr')){
header( 'Location: https://exams.vithoulkas.edu.gr' ) ;
}
//echo $https .'-'.$url;
//if($url!='exams.vithoulkas.edu.gr'){echo 'test';}
?>
...
if ($show == 'result') {
	...
	$table = new SortableTable('quiz_results', '100', 'get_exam_results_data');
