...
$AudioCase = "Caso em audio";
$PaperCase = "Caso vivo e escrito";
$hours = "horas";
$Newhorizon06Theory1 = "Definição de Saúde (parte 1)";
$Newhorizon06Theory2 = "Definição de Saúde (parte 1)";
$NewhorizonTopics1 = "As condições para ter uma criança saudável";
$NewhorizonTopics2 = "Sobre a imaginação";
$Newhorizon06Theory3 = "O surgimento da teoria dos Níveis de Saúde";
$Newhorizon06Levels = "A teoria dos Níveis de Saúde - Parte";
$Newhorizon06Theory4 = "O contínuo de uma teoria unificada das doenças";
?>