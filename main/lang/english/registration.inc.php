...
$RegInstructions = "As soon as payment is received, the corresponding training sessions will be unlocked for your account."; //added
$GreekException = "Submission of this form implies that you have read and accepted the Student Agreement (found on the Homepage of the E-learning platform)."; //added
...
$HaveFun = "We look forward to welcoming you to the course.";
$YouCanNowLoginAtXUsingTheLoginAndThePasswordYouHaveProvided = "Now you can login to the E-learning Platform using the username and the password you have provided.";
