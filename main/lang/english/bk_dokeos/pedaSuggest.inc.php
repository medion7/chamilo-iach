...
$ObjectivesQuestions = "What should the end results be when the student has completed the training? What are the activities performed during the training?";
$Topics = "Topics";
...
$TopicsQuestions = "How does the training progress? Where should the student pay special care? Are there identifiable problems in understanding different areas? How much time should one dedicate to the different areas of the training?";
...
$AssessmentQuestions = "How will students be assessed? Are there strategies to develop in order to master the topic?";
