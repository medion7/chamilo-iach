...
$TemplateTitleLearnerWonder = "Student wonder";
$TemplateTitleLearnerWonderDescription = "Student wonder description";
...
$HelpSharedFolder = "This directory contains the files that other student (or yourself) sent into a course through the editor (if they didn\'t do it from the groups tool). By default, they will be visible by any trainer, but will be hidden from other students (unless they access the files directly). If you make one user directory visible, other users will see all its content.";
