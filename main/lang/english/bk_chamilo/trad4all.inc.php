...
$Student = "Student";
$Teacher = "Trainer";
$Send2All = "You did not select a user / group. The announcement is visible for every student";
$Wiki = "Group wiki";
$Complete = "Complete";
...
$RemindInactivesLearnersSince = "Remind students inactive since";
...
$DateSend = "Date sent";
$Deny = "Deny";
$ThereIsNotQualifiedLearners = "There are no qualified students";
$ThereIsNotUnqualifiedLearners = "There are no unqualified students";
...
$ThereAreNoRegisteredLearnersInsidetheCourse = "There are no registered students inside the course";
