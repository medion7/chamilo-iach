...
$langShowScor = "Show score to student:";
$langStep1 = "Step 1";
$langStep2 = "Step 2";
$langTake = "take";
$langAmong = "among";
...
$OpenQuestionsAttempted = "A student has answered an open question";
...
$ResultsEnabled = "Results enabled for students";
$ResultsDisabled = "Results disabled for students";
$ExportWithUserFields = "Include profiling";
$ExportWithoutUserFields = "Exclude profiling";
$DisableResults = "Do not show results";
$EnableResults = "Show results to students";
...
$ShowResultsToStudents = "Show score to student";
...
$LearnerIsInformed = "This message, as well as the results table, will appear to the student if he fails this step";
$MinOverlap = "Minimum overlap";
$MaxExcess = "Maximum excess";
$MaxMissing = "Maximum missing";
$IfNoError = "If no error";
$LearnerHasNoMistake = "The student made no mistake";
...
$ExerciseAttempted = "A student attempted an exercise";
