...
$ShowStudentViewComment = "Enable Student View?<br>This feature allows the trainer to see the student view.";
...
$AllowUserHeadingsComment = "Can a trainer define student profile fields to retrieve additional information?";
$Platform = "Portal";
$Course = "Course";
$Languages = "Languages";
$Privacy = "Privacy";
...
$AllowPersonalAgendaComment = "Can the student add personal events to the Agenda?";
...
$UseSessionModeComment = "Training sessions give a different way of dealing with training, where training have an author, a coach and students. Each coach gives a training for a set period of time, called a *training session*, to a set of students who do not mix with other student groups attached to another training session.";
...
$LDAPSynchroImportUsersAndStepsInSessions = "LDAP synchro: Import students/steps into course sessions";
...
$AllowStudentsToBrowseCoursesComment = "Allow students to browse the courses catalogue and subscribe to available courses";
...
$AllowStudentsToBrowseCoursesTitle = "Students access to courses catalogue";
...
$LastTimeTheCourseWasUsed = "Last time student entered the course";
...
$ShowGroupsToUsersComment = "Show the classes to users. Classes are a feature that allow you to register/unregister groups of users into a session or a course directly, reducing the administrative hassle. When you pick this option, students will be able to see in which class they are through their social network interface.";
