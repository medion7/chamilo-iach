...
$table = new SortableTable('users_tracking', array('Cases', 'get_number_of_cases'), array('Cases', 'get_data_of_cases') , (api_is_western_name_order() xor api_sort_by_first_name()) ? 3 : 2);
