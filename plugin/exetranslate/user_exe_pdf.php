...
if (api_is_allowed_to_edit()==1 || api_is_platform_admin($allow_sessions_admins)==1) {
	...
	$table = new SortableTable('exercises', array('ExportTool', 'get_exe_number'), array('ExportTool', 'get_exe_data'), '', 100);

    $table->set_additional_parameters($parameters);
    $tab_table_header = array();    // tab of header texts
    $table->set_header(0, get_lang('Exe_id'), true);
