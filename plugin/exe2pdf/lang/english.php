...
$strings['plugin_title']        = "Exercises to PDF";
$strings['plugin_comment']      = "Exercises to PDF";

$strings['Exe2pdf']     = "Exercises to PDF";
$strings['ExportExercise']       = "Export quiz to pdf";
$strings['QuizTitle']       = "Quiz title";
$strings['Quiz_id'] = "Quiz ID";
$strings['Exe_id']        = "Exercise ID";
